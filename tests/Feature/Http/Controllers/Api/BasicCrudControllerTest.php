...
class BasicCrudControllerTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $request
            ->shouldReceive('all')
            ->once()
            ->andReturn(['name' => 'name_test', 'description' => 'test_description']);
    ...
    public function testIfFindOrFailThrowsExceptionWhenIdIsInvalid()
    {
    ...
    public function testUpdate()
    {
        ...
        $request
            ->shouldReceive('all')
            ->once()
            ->andReturn(['name' => 'name_test_changed', 'description' => 'test_description_changed']);
